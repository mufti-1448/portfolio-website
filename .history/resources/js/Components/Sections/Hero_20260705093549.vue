    ...
    >
        ...
        >
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <!-- Right Column: Profile Image with Hover Animation + Rotation -->
<div
    style="
...
>
    <div
        ...
        /* MOUSEENTER: Scale + Glow + Rotate */
        @mouseenter="
            $event.currentTarget.style.transform = 'scale(1.05) rotate(45deg)';
            $event.currentTarget.style.boxShadow = '0 0 30px rgba(56, 189, 248, 0.5), var(--glass-shadow)';
        "
        
        /* MOUSELEAVE: Return ke normal state */
        @mouseleave="
