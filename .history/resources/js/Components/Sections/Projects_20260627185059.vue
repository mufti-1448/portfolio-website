...
const projectsData = [
    {
        ...
        description:
            "A comprehensive admin dashboard for managing products, orders, and analytics with real-time data.",
    ...
    },
    {
        ...
        description:
            "Modern personal portfolio website with dark mode, bilingual support, and admin panel.",
        image: "https://via.placeholder.com/400x300?text=Portfolio+Website",
        techStack: ["Vue.js", "Inertia.js", "Laravel", "Tailwind"],
        github: "#",
        live: "#",
    },
    {
