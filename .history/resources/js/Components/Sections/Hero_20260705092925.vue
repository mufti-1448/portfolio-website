    ...
    >
        ...
        >
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div style="animation: slideInRight 400ms ease-out 160ms forwards; opacity: 0;">
    <div
        ...
        style="
            ...
            cursor: pointer;
        "
        @mouseenter="$event.currentTarget.style.transform = 'perspective(1000px) rotateY(5deg) rotateX(-2deg)'"
        @mouseleave="$event.currentTarget.style.transform = 'perspective(1000px) rotateY(0deg) rotateX(0deg)'"
    >
        <img src="/images/profile.jpeg" alt="Foto profil Ali" style="width: 100%; height: 100%; object-fit: cover; display: block;" />
    </div>
</div>
            </div>
        </div>
