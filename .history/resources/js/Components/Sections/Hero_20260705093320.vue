    ...
    >
        ...
        >
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div
    style="animation: slideInRight 400ms ease-out 160ms forwards; opacity: 0;"
>
    <div
        ...
        "
        @mouseenter="
            $event.currentTarget.style.transform = 'perspective(1000px) rotateY(3deg) rotateX(-2deg) scale(1.02)';
