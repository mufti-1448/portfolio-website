...
const groupedSkills = computed(() => {
    const groups = {};
    if (!props.skills || props.skills.length === 0) return groups;
...
// Get category keys for animation delay
const categoryKeys = computed(() => {
    return Object.keys(groupedSkills.value);
});
</script>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-12">
                <div
                    ...
                    "
                    :style="{
    animationDelay: `${categoryKeys.indexOf(category) * 100}ms`,
}"
                >
                    <!-- Category Title -->
                    <div class="mb-6">
