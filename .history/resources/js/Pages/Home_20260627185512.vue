...
// Track scroll untuk parallax effect (optional)
...
<template>
    <PublicLayout title="Ali - Portfolio">
        <!-- Hero Section -->
        <section
                ...
                >
                    ...
                    <div>
                        ...
                        <h1
                            ...
                            style="
                                animation: slideInUp 600ms ease-out 100ms
                                    forwards;
                                opacity: 0;
                            "
                        >
                        ...
                        <h2
                            ...
                            style="
                                ...
                                animation: slideInUp 600ms ease-out 200ms
                                    forwards;
                                opacity: 0;
                            "
                        >
                        ...
                        <p
                            ...
                            style="
                                color: var(--color-text-secondary);
                                animation: slideInUp 600ms ease-out 300ms
                                    forwards;
                                opacity: 0;
                            "
                        >
                            Passionate about Web Development, Software
                            Engineering, UI/UX, and Database Design. Building
                            digital products and continuously learning modern
                            technologies.
                        </p>
                        ...
                        <div
                            ...
                            style="
                                animation: slideInUp 600ms ease-out 400ms
                                    forwards;
                                opacity: 0;
                            "
                        >
                    ...
                    <div
                        style="
                            animation: slideInRight 600ms ease-out 200ms
                                forwards;
                            opacity: 0;
                        "
                    >
