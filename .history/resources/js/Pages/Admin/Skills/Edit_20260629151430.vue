...
const initializeForm = () => {
    if (props.skill) {
        ...
        form.value.category = props.skill.category || 'Frontend';
        form.value.icon = props.skill.icon || '';
        form.value.proficiency = props.skill.proficiency || 3;
    }
};
...
const submitForm = async () => {
    ...
    try {
        ...
        const response = await axios.post(route('admin.skills.update', props.skill.id), {
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                <input
                                    ...
                                    class="w-4 h-4"
                                />
                                <span style="color: var(--color-text-primary); font-medium;">
                                    {{ level.label }}
                                </span>
                            </label>
                        </div>
