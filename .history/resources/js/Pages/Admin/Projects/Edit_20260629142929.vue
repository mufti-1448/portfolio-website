...
const techOptions = ['Vue.js', 'Laravel', 'MySQL', 'Tailwind CSS', 'React', 'Node.js', 'Python', 'Django'];
const errors = ref({});
...
const initializeForm = () => {
    if (typeof project !== 'undefined' && project) {
        ...
        form.value.github_url = project.github_url || '';
        form.value.live_url = project.live_url || '';
        form.value.is_featured = project.is_featured || false;
    }
};
...
const submitForm = async () => {
    ...
    try {
        ...
        // Submit using axios
        const response = await axios.post(route('admin.projects.update', project.id), formData, {
            headers: {
                ...
                <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            "
                        />
                        <p v-if="errors.title" class="text-xs mt-1" style="color: #ef4444;">
                            {{ errors.title }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            "
                        ></textarea>
                        <p v-if="errors.description" class="text-xs mt-1" style="color: #ef4444;">
                            {{ errors.description }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p v-if="errors.image" class="text-xs mt-1" style="color: #ef4444;">
                            {{ errors.image }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button
                                ...
                                :style="{
                                    ...
                                    border: '1.5px solid ' + (form.tech_stack.includes(tech)
                                        ? 'var(--color-primary)'
                        ...
                        <p v-if="errors.tech_stack" class="text-xs mt-2" style="color: #ef4444;">
                            {{ errors.tech_stack }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            "
                        />
                        <p v-if="errors.github_url" class="text-xs mt-1" style="color: #ef4444;">
                            {{ errors.github_url }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            "
                        />
                        <p v-if="errors.live_url" class="text-xs mt-1" style="color: #ef4444;">
                            {{ errors.live_url }}
                        </p>
                    </div>
