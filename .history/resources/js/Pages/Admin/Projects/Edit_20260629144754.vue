...
const projectId = new URLSearchParams(window.location.search).get('project') || 
                  window.location.pathname.split('/').filter(p => !isNaN(p))[0];
...
const initializeForm = () => {
    if (props.project) {
        ...
        form.value.tech_stack = props.project.tech_stack || [];
        form.value.github_url = props.project.github_url || '';
        form.value.live_url = props.project.live_url || '';
        form.value.is_featured = props.project.is_featured || false;
    }
};
