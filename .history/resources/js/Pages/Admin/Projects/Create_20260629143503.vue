...
const submitForm = async () => {
    ...
    try {
        ...
        console.log('Tech Stack:', form.value.tech_stack);
        console.log('GitHub URL:', form.value.github_url);
        console.log('Live URL:', form.value.live_url);
        console.log('Is Featured:', form.value.is_featured);
