...
// ============================================
/**
 * Gunakan useLanguage composable untuk:
 * - language: reactive state dari current language
 * - setLanguage: function untuk ganti language
  ...
  <div style="background: var(--color-bg-primary);">
    ...
    >
      <div class="navbar-container">
        ...
        <!-- Right Actions (Language Toggle + CV + Mobile Menu) -->
        <div class="navbar-actions">
          <!-- ✅ LANGUAGE TOGGLE BUTTONS (NEW) -->
          <div class="language-toggle">
            <button
              @click="setLanguage('id')"
              class="lang-button"
              :style="{
                background: language === 'id' ? 'rgba(37, 99, 235, 0.2)' : 'transparent',
                color: language === 'id' ? 'var(--color-primary)' : 'var(--color-text-secondary)',
              }"
            >
              ID
            </button>
            ...
            <button
              ...
              class="lang-button"
              :style="{
                background: language === 'en' ? 'rgba(37, 99, 235, 0.2)' : 'transparent',
                color: language === 'en' ? 'var(--color-primary)' : 'var(--color-text-secondary)',
              }"
            >
              EN
            </button>
