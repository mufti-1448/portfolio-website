...
const sidebarLinks = [
    ...
    { label: 'Certificates', href: route('admin.certificates.index'), icon: '🏆' },
    { label: 'Experiences', href: route('admin.experiences.index'), icon: '💼' },
            ...
            <div class="p-6">
                ...
                <nav class="space-y-2">
                    <Link
                        ...
                        :style="{
                            backgroundColor: route().current(link.href) ? 'rgba(37, 99, 235, 0.2)' : 'transparent',
                            color: route().current(link.href) ? 'var(--color-accent)' : 'var(--color-text-secondary)',
                        }"
                    >
                ...
                <!-- Logout -->
                <div class="mt-8 pt-8 border-t" style="border-color: rgba(148, 163, 184, 0.1);">
                    <button
                        @click="logout"
