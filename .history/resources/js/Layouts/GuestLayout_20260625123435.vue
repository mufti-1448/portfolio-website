  ...
  <div class="min-h-screen flex items-center justify-center" style="background-color: var(--color-bg-primary);">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        ...
        style="background: rgba(56, 189, 248, 0.1); filter: blur(40px);"
      ></div>
      <div
        class="absolute bottom-20 left-20 w-72 h-72 rounded-full"
        style="background: rgba(37, 99, 235, 0.1); filter: blur(40px);"
      ></div>
    </div>
    ...
    <div class="relative z-10 w-full max-w-md px-4">
      ...
      <div class="mb-8 text-center">
        <h1 class="text-3xl font-bold" style="color: var(--color-accent);">
          Portfolio
        </h1>
      </div>
